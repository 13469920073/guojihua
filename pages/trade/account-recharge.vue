<template>
	<view class="content">
		<view class="uni-account-card">
			<view  style="padding: 14px; padding-top: 25px; display: flex;flex-direction: column;align-items: center;">
				<h3 class="uni-account-title">
					收款账户<text class="rgcz">人工充值</text>
				</h3>
				...
				<view class="table-from" style="">
					<view class="flex">账户名称<text class="table-input"><input v-model="from.name"  /></text></view> 
					<view class="flex">账户地址<text class="table-input"><input v-model="from.address"/></text></view> 
					<view style="display: flex; align-items: center;margin-top: 10px;">
						<view style="margin-left: 5px;color: #f66;">*注意：官方收款账户，请仔细核对信息</view> 
					</view>
				</view>
			</view>
        </view>
		<view class="flex" style="padding: 20px;">
			...
			<text>转账完成，提交打款信息</text>
		</view>
		<view style="padding: 20px;">
			<button type="primary" style="margin-top: 60px; background-color: #0080ff;height: 45px;" v-on:click="next">下一步</button>	
		</view>
	</view>
</template>
