    ...
    <view class="uni-account-card">
      <view style="padding: 14px; padding-top: 25px; display: flex;flex-direction: column;align-items: center;">
        ...
        <view class="grid-item-wrap flex" style="width: 100%;">
          <view class="grid-item-left" :class="navIndex == k ? 'activite' : ''" v-for="(arr, k) in itemType" :key="k"
            v-on:click="publish(arr, k)">
            {{ arr.type }}
          </view>
        </view>
  ...
  data() {
    return {
      ...
      itemType: [{
        ...
        address: '0x4e22D50131894247C16C03Cf53aC6Dd08B3aa636',
        photo: '../../static/images/trade/ETH-12.jpg'
      }, {
        type: 'DOGE',
        accountName: 'DOGE',
        address: 'DAAGu88iTEhxyKVNVBKo4LwiFSVCdEGHNd',
        photo: '../../static/images/trade/DOGE-1.jpg'
      }],
      from: {
